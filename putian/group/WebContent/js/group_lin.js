var PList2 = [{ id: "P0", name: "曾真", photo: "", information: "" },
    ...
    { id: "P3", name: "林爱香", photo: "", information: "" },
    { id: "P4", name: "陈建煌", photo: "", information: "" },
    { id: "P8", name: "程慧斌", photo: "", information: "" },
    ...
    { id: "P21", name: "林新强", photo: "", information: "" },
    { id: "P22", name: "林新潮", photo: "", information: "" },
    { id: "P23", name: "林淑花", photo: "", information: "" },
    { id: "P24", name: "吴亚平", photo: "", information: "" },
    { id: "P25", name: "林新平", photo: "", information: "" },
    { id: "P26", name: "詹妍", photo: "", information: "" },
    { id: "P27", name: "林丽君", photo: "", information: "" }
];
...
var CList2 = [{ id: "C0", name: "杭州虹桥医院", m: "B", information: "" },
    ...
    { id: "C8", name: "上海远大心胸医院", m: "B", information: "" },
    { id: "C9", name: "深圳曙光医院", m: "B", information: "" },
    ...
    { id: "C53", name: "深圳五洲中西医结合医院", m: "B", information: "" },
    { id: "C54", name: "黑龙江和美妇产医院", m: "B", information: "" },
    { id: "C55", name: "山西现代妇产医院", m: "B", information: "" },
    { id: "C56", name: "深圳远东妇产医院", m: "B", information: "" },
...
var PS2 = ["P0", "P26", "P8", "P1", "P2", "P4", "P11", "P13", "P15", "P14", "P17", "P19", "P21", 'P22', "P25", 'P23', 'P27', "P3", "P10", "P18", "P12", "P20", "P16",
    "P24"
];

var CS2 = ["C2", "C4", "C12", "C3", "C5", "C6", "C7", "C0", "C1", "C21", "C10", "C11",
    "C25", "C27", "C30", "C37", "C32", "C35", "C40", "C33", "C34", "C36", "C38", "C39", "C54", "C42", "C45", "C43", 'C53', 'C9', "C49", "C46", "C47", "C48", "C8",
    "C56",
    "C26",
    "C28", "C29",

    "C31", "C41", "C20", "C19", "C44", "C52", "C24", "C22", "C23", "C55",

    "C57", "C58", "C63", "C59", "C60", "C65", "C66", "C79", "C67", "C68", "C69", "C70", "C74", "C73", "C71", "C72",
    ...
    .ready(
        function() {
            ...
            var LogoAndLegend = function() {
                ...
                this.CCMLegendX = 90 + cenNum;
                this.CMLegendX = 290 + cenNum;
                this.LegendY = 800;
                this.y = 20;
            };
            ...
            C.prototype.display = function() {
                ...
                main.fillStyle = this.color;
                main.font = this.font;
                verticalText(this.name, this.x, this.y,
                    this.lineHeight)
            };
            ...
            CP.prototype.display = function() {
                ...
                if (this.p.name == "林玉明" && this.c.m == "B") {
                    ...
                    main.lineTo(this.p.x - 96, this.p.y + 130);
                    //alert(this.p.x + 190);this.p.x + 190=799
                    //alert(this.p.y + 130);this.p.y + 130=230
                    main.stroke();
                    main.beginPath();
                    main.moveTo(this.p.x - 96, this.p.y + 130);
                    main.lineTo(this.p.x - 96, this.p.y + 430);
                    main.stroke();

                    main.beginPath();
                    main.moveTo(this.p.x - 96, this.p.y + 430);
                    main.lineTo(this.c.x, this.c.y);
                    main.stroke();
                } else if (this.p.name == "林玉国" && this.c.m == "B" || this.p.name == "林丽君" && this.c.m == "B" || this.p.name == "林新强" && this.c.m == "B" || this.p.name == "林新潮" && this.c.m == "B" || this.p.name == "林淑花" && this.c.m == "B" || this.p.name == "林爱香" && this.c.m == "B" ||
                    ...
                    if (this.p.name == "林志通" && this.c.name == "深圳和美妇儿科医院" || this.p.name == "吴亚平" && this.c.name == "黑龙江和美妇产医院" ||
                        ...
                        this.c.name == "上海天大医疗美容医院" || this.c.name == "上海沪申五官科医院" || this.c.name == "上海远大心胸医院" || this.c.name == "深圳博爱医院" ||
                        this.c.name == "深圳曙光医院" || this.c.name == "深圳五洲中西医结合医院") {
                        main.beginPath();
                        main.moveTo(770, 230);
                        main.lineTo(770, 530);
                        main.stroke();
